...
inputs = [
    ...
    ['MULTIJET_Run2012ABCD-22Jan2013_analysis_woPU_pt30_eta50_puJetIdT_HLTsel_woPtRecoilCut_afterPrescaleReweighting.root', '../weightPlots/output_rootfile/10Jun14/data/MULTIJET_Data_merged_2012_woPU_pt30_eta50_puJetIdT_afterPrecaleReweighting.root', "isData", "_pt30_eta50_puJetIdT_HLTsel_woPtRecoilCut_afterPrescaleReweighting_newHLTSel", ".pdf"],

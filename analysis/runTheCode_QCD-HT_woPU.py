...
inputs = [
    #['MULTIJET_MC_QCD-HT-100ToInf_analysis_woPU_pt30_eta50_puJetIdT_HLTsel_woPtRecoilCut.root', '../weightPlots/output_rootfile/23May14/MC/MULTIJET_MC_QCD-HT_merged_woPU_pt30_eta50_puJetIdT.root', "isMC", "_pt30_eta50_puJetIdT_HLTsel_woPtRecoilCut_QCD-HT", ".pdf"],
    ['MULTIJET_Run2012ABCD-22Jan2013_analysis_woPU_pt30_eta50_puJetIdT_HLTsel_woPtRecoilCut_beforePrescaleReweighting.root', '../weightPlots/output_rootfile/23May14/data/MULTIJET_Data_merged_2012_woPU_pt30_eta50_puJetIdT_beforePrecaleReweighting.root', "isData", "_pt30_eta50_puJetIdT_HLTsel_woPtRecoilCut_beforePrescaleReweighting", ".pdf"],

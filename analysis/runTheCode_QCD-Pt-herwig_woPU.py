...
inputs = [
    ['MULTIJET_MC_QCD-Pt-herwig-120ToInf_analysis_woPU_pt25_eta50_puJetIdMT_HLTsel_woPtRecoilCut.root', '../weightPlots/output_rootfile/14Mar14/MC/MULTIJET_MC_QCD-Pt-herwig_merged_woPU_pt25_eta50_puJetIdMT_14Mar14.root', "isMC", "_pt25_eta50_puJetIdMT_HLTsel_woPtRecoilCut_QCD-Pt-herwig", ".pdf"],

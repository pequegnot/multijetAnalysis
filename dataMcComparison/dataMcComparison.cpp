...
/*    h1_style(hLeadingAndSecondJetsMass_afterSel_mc_lumi);*/
 ...
 /*   TH1* hLeadingAndSecondJetsMass_afterSel_mc_lumi_zoom = (TH1F*)hLeadingAndSecondJetsMass_afterSel_mc_lumi->Clone();*/
    ...
    if(inLinScale) {
      ...
      drawDataMcComparison("SecondJetPt_beforeSel", hSecondJetPt_beforeSel_mc_lumi, hSecondJetPt_beforeSel_data_lumi, "p_{T}^{2^{nd} jet} [GeV]", myHistoName.c_str(), inLinScale);
      myHistoName = "images/variables/SecondJetPt_afterSel_lumi_inLinScale" + extension;
      drawDataMcComparison("SecondJetPt_afterSel", hSecondJetPt_afterSel_mc_lumi, hSecondJetPt_afterSel_data_lumi, "p_{T}^{2^{nd} jet} [GeV]", myHistoName.c_str(), inLinScale);
  ...
  if(isShapeNorm) {
    ...
    if(inLinScale) {
      ...
      drawDataMcComparison("SecondJetPt_beforeSel", hSecondJetPt_beforeSel_mc_shape, hSecondJetPt_beforeSel_data_shape, "p_{T}^{2^{nd} jet} [GeV]", myHistoName.c_str(), inLinScale);
      myHistoName = "images/variables/SecondJetPt_afterSel_shape_inLinScale" + extension;
      drawDataMcComparison("SecondJetPt_afterSel", hSecondJetPt_afterSel_mc_shape, hSecondJetPt_afterSel_data_shape, "p_{T}^{2^{nd} jet} [GeV]", myHistoName.c_str(), inLinScale);

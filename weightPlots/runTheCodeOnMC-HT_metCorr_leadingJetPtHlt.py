...
#        ['MULTIJET_QCD_HT-100To250_woPU_pt30_eta50_puJetIdT_firstJetPtHLTBin.root', 'list/MULTIJET_QCD_HT-100To250_woPU_pt30_eta50_puJetIdT_METCorrPu_16Jun14.list', 50097518, 10360000],
        ...
        ['MULTIJET_QCD_HT-100To250_woPU_pt30_eta50_firstJetPtHLTBin.root', 'list/MULTIJET_QCD_HT-100To250_woPU_pt30_eta50_puJetIdT_type1fix.list', 50097518, 10360000],
        ['MULTIJET_QCD_HT-250To500_woPU_pt30_eta50_firstJetPtHLTBin.root', 'list/MULTIJET_QCD_HT-250To500_woPU_pt30_eta50_puJetIdT_type1fix.list', 27062078, 276000],
        ['MULTIJET_MC_QCD_HT-500To1000_woPU_pt30_eta50_firstJetPtHLTBin.root', 'list/MULTIJET_QCD_HT-500To1000_woPU_pt30_eta50_puJetIdT_type1fix.list', 30249292, 8426],
        ['MULTIJET_MC_QCD_HT-1000ToInf_woPU_pt30_eta50_firstJetPtHLTBin.root', 'list/MULTIJET_QCD_HT-1000ToInf_woPU_pt30_eta50_puJetIdT_type1fix.list', 13808863,204],
        ]
...
args = ["hadd","-f", "output_rootfile/%s/MC/MULTIJET_MC_QCD-HT_merged_woPU_pt30_eta50_firstJetPtHLTBin_type1fix.root" % (d)]
path = "output_rootfile/%s/MC" % (d)
